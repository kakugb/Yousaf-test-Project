...
const Navbar = () => {
    ...
    const [personalityTestDropdownOpen, setPersonalityTestDropdownOpen] = useState(false);
                    ...
                    <div className="flex space-x-8">
                        ...
                        >
                            <button
                                ...
                                className={`${
                                    active === 'personalityTest' ? 'border-b-2 border-blue-500' : ''
                                } text-gray-700 hover:text-blue-500`}
                            >
                                Personality Test
                            </button>
                            {personalityTestDropdownOpen && (
                                <div className="w-64 absolute z-10 right-0  bg-white shadow-lg rounded-md p-4 shadow-gray-400">
                                    <div className="py-2">
                                        ...
                                        <button className="block w-full text-left text-gray-700 hover:bg-gray-100 py-2">Enneagram Personality Test</button>
                                        </Link>
                                        <button className="block w-full text-left text-gray-700 hover:bg-gray-100 py-2">16 Types Personality Test</button>
                                        <button className="block w-full text-left text-gray-700 hover:bg-gray-100 py-2">Big Five Personality Test</button>
                                        <Link to='/DISCPersonalityTest'>
                                        <button className="block w-full text-left text-gray-700 hover:bg-gray-100 py-2">DISC Personality Test</button>
                                        </Link>
                                        <button className="block w-full text-left text-gray-700 hover:bg-gray-100 py-2">Emotional Intelligence Test</button>
                                        <button className="block w-full text-left text-gray-700 hover:bg-gray-100 py-2">Career Aptitude Test</button>
                                        <button className="block w-full text-left text-gray-700 hover:bg-gray-100 py-2">7 Love Styles Test</button>
                                    </div>
                                </div>
                            )}
                        </div>

...
const EmotionalPersonalityTest = () => {
  ...
  // Fetch Emotional Intelligence questions
  useEffect(() => {
    axios
      .get("http://localhost:3000/api/emotional-intelligence/questions")
      .then((response) => {
  ...
  const handleSubmit = (event) => {
    ...
    axios
      .post("http://localhost:3000/api/emotional-intelligence/submit", payload)
      .then((response) => {
        setIsSubmitting(false);
        const result = response.data;
        console.log("Result:", result);
        navigate("/emotional-result", { state: result });
      })
      .catch((error) => {
...
export default EmotionalPersonalityTest;
